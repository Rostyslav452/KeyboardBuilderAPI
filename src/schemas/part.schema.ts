...
const FormFactors = ['60%', '65%', '75%', 'TKL', 'Full-size', '96%'] as const;
const SwitchTypes = ['Linear', 'Tactile', 'Clicky', 'Silent'] as const;
const Materials = ['ABS', 'PBT', 'Aluminum', 'Polycarbonate', 'Acrylic', 'FR4'] as const;
...
const createPartsBodySchema = z.array(
...
const updatePartBodySchema = z.discriminatedUnion('type', [
...
type CreatePartsDto = z.infer<typeof createPartsBodySchema>;
type UpdatePartDto = z.infer<typeof updatePartBodySchema>;

export { CreatePartsDto, UpdatePartDto, createPartsBodySchema, updatePartBodySchema };
