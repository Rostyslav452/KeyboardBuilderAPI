...
import { createBuildSchema, updateBuildSchema } from '../schemas/build.schema.js';
...
router
    ...
    .post(authentication, validate(createBuildSchema), buildsController.createBuild);
...
router
    ...
    .patch(authentication, validate(updateBuildSchema), buildsController.updateBuild)
    .delete(authentication, validate(paramsIdSchema), buildsController.deleteBuild);
